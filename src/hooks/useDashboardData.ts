...
export const useDashboardData = (period: Period, stationId?: string | null) => {
  ...
  const chartQuery = useQuery({
    ...
    queryFn: async () => {
      ...
      let query = supabase
        .from("index_entries")
        .select("entry_date, station_id, super1_index_depart, super1_index_arrivee, super2_index_depart, super2_index_arrivee, gasoil1_index_depart, gasoil1_index_arrivee, gasoil2_index_depart, gasoil2_index_arrivee")
